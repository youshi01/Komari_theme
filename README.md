...
- 支持卡片样式、指标配色与跑马灯动态样式预设，内置数据面板、清透玻璃、霓虹暗面、柔和彩块、极简白板等卡片风格，以及经典点阵、极光丝带、电路线条、霓虹脉冲、均衡器方块等跑马灯形态；CPU、内存、磁盘、负载、延迟、丢包率和上下行点阵都可单独自定义，游客可在首页保存本机样式，管理员可在主题管理页保存全站默认。
