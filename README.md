...
- 支持卡片外壳、信息展板、指标配色与数据条动态样式预设，卡片外壳内置数据面板、清透玻璃、霓虹暗面、柔和彩块、极简白板，信息展板内置数据条、弧光仪表、全环仪表、指针仪表；数据条可单独调整跑马灯形态、密度、圆角、光晕和动效，游客可在首页保存本机样式，管理员可在主题管理页保存全站默认。
...
- 设置全站默认卡片外壳、信息展板、数据条动态样式、指标配色和跑马灯配色。
- 设置全站默认渐变背板和图片背景板。
