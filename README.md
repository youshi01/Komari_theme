...
- 支持卡片形态、卡片外壳、信息展板、指标配色与数据条动态样式预设，卡片形态可在方型卡片和条形卡片之间切换；卡片外壳内置数据面板、清透玻璃、霓虹暗面、柔和彩块、极简白板、复古 CRT，信息展板内置数据条、弧光仪表、全环仪表、指针仪表、液位容器；数据条可单独调整跑马灯形态、密度、圆角、光晕和动效，游客可在首页保存本机样式，管理员可在主题管理页保存全站默认。
...
- 液位容器支持水波圆球、横向胶囊舱、竖向液柱、椭圆透镜、分段胶囊、六边晶核、悬浮水滴、环形液舱等形态，并带有轨道、扫描、刻度、晶体切面、传输节点等专属未来风格细节；可调整波浪高度、玻璃强度、光晕、动效和纹理。
...
- 设置全站默认卡片形态、卡片外壳、信息展板、数据条动态样式、指标配色和跑马灯配色。
- 设置全站默认渐变背板和图片背景板。
